...
const bracketSlides = [
  ...
  {
    type: "video",
    src: `${basePath}Stress_Field_Overlay.mp4`,
    label: "Stress-field overlay",
    detail: "Recorded stress-field-to-optimized-geometry comparison",
    alt: "Looped stress-field overlay showing the relationship between the baseline stress field and optimized bracket geometry",
  },
  {
    type: "image",
                ...
                <div className="bracket-gallery-slide" key={`${slide.label}-${index}`}>
                  <div className="bracket-gallery-view">
                    {slide.type === "comparison" ? (
                      ...
                      <video
                        className="bracket-overlay-video"
                        src={slide.src}
                        autoPlay
                        muted
                        loop
