...
const bracketSlides = [
  ...
  },
  {
    ...
    detail: "50% optimized-geometry overlay on the baseline stress result",
    baseSrc: `${basePath}bracket-baseline-stress.png`,
    overlaySrc: `${basePath}bracket-optimized-geometry.png`,
    alt: "Semi-transparent overlay of the final optimized bracket over the baseline stress field",
  },
  {
    type: "image",
                  ...
                  <div className="bracket-gallery-view">
                    {slide.type === "comparison" ? (
                      ...
                      <div className="bracket-overlay">
                        <img src={slide.baseSrc} alt="" aria-hidden="true" />
                        <img src={slide.overlaySrc} alt={slide.alt} />
                        <span className="bracket-overlay-badge">50% optimized geometry overlay</span>
                      </div>
                    ) : (
